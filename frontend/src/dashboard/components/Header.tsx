...
export default function Header() {
  ...
  return (
    <div className="flex items-center justify-between w-full lg:w-auto lg:w-[calc(100% - 231px)] xl:w-[calc(100% - 250px)] lg:ml-[231px] xl:ml-[250px] bg-white p-6 border-b-[2px] border-gray-e6 lg:py-7 lg:px-6 xl:px-10 xl:py-[33px]">
      <img
